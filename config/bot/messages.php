...
return [
    ...
    "requestPackageAdmin" => "سفر\n\nشماره درخواست :code\n\nمبدا : :fromCountry , :fromCity, :fromAddress\nبه مقصد : :toCountry , :toCity, :toAddress\n\nتاریخ سفر : :date\nجداکثر وزن : :weight\nقیمت پیشنهادی : :price\n\nنوضیحات: :desc\n\n:hasTicket تصثویر بلیط\n:hasPassport تصویر مدارک شناسایی\n:hasContact اطلاعات تماس\n\n\nبسته\n\nشماره درخواست :packageCode\n\nمبدا : :packageFromCountry , :packageFromCity , :packageFromAddress\nمقصد : :packageToCountry , :packageToCity , :packageToAddress\n\nنوضیحات: :packageDesc\n\n:packageHasPassport تصویر مدارک شناسایی\n:packageHasContact اطلاعات تماس",
    "requestTripAdmin" => "بسته\n\nشماره درخواست :code\n\nمبدا : :fromCountry , :fromCity , :fromAddress\nمقصد : :toCountry , :toCity , :toAddress\n\nنوضیحات: :Desc\n\n:hasPassport تصویر مدارک شناسایی\n:hasContact اطلاعات تماس\n\n\nسفر\n\nشماره درخواست :tripCode\n\nمبدا : :tripFromCountry , :tripFromCity, :tripFromAddress\n\nمقصد : :tripToCountry , :tripToCity, :tripToAddress\n\nتاریخ سفر : :tripDate\nجداکثر وزن : :tripWeight\nقیمت پیشنهادی : :tripPrice\n\nنوضیحات: :tripDesc\n\n:tripHasTicket تصویر بلیط\n:tripHasPassport تصویر مدارک شناسایی\n:tripHasContact اطلاعات تماس",
    ...
    "cancelEdit" => "عملیات لفو شد",
    "cardsNotFound" => "درحال حاضر درخواستی وجود ندارد!",
